...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm,height=5.47cm]{struktur-sqlite}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|m{3.5cm}|c|m{4.5cm}|}
        ...
        1 & Arduino Uno & \includegraphics[width=4.00cm,height=2.72cm]{arduino-uno} & Untuk membuat berbagai hal yang berkaitan dengan fungsi mikrokontroler. \\ \hline
        2 & Gyroscope MPU6050 & \includegraphics[width=4.00cm,height=5.22cm]{mpu6050} & Sensor ini bisa mendeteksi gerakan kemiringan sesuai gravitasi, sehingga bisa digunakan untuk mendeteksi gerakan pengguna. \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5.52cm,height=10.90cm]{struktur-kode-1}\hspace{0.3cm}\includegraphics[width=6.76cm,height=10.90cm]{struktur-kode-2}
