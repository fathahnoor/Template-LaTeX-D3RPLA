...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Komponen Aplikasi Android)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Arsitektur Aplikasi)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Use Case Diagram)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Struktur Data Firebase Realtime Database)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Struktur Data SQLite)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Rancangan Skematik Perangkat)\vspace{3cm}}}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|p{4cm}|p{6cm}|}
        \hline
        \textbf{No.} & \textbf{Komponen} & \textbf{Penjelasan} \\ \hline
        1 & Arduino Uno & Untuk membuat berbagai hal yang berkaitan dengan fungsi mikrokontroler. \\ \hline
        2 & Gyroscope MPU6050 & Sensor ini bisa mendeteksi gerakan kemiringan sesuai gravitasi, sehingga bisa digunakan untuk mendeteksi gerakan pengguna. \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Struktur Kode Project)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Perbedaan UI Rancangan dan Implementasi)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Hasil Inspect Code)\vspace{3cm}}}
...
\end{minipage} \\ \hline
        ...
        \textbf{Hasil} & (lampirkan screenshot hasil) \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\textwidth}{\centering\vspace{3cm}(Grafik Respon Effectiveness)\vspace{3cm}}}
...
\begin{itemize}
    \item Foto bersama siswa yang diwawancarai dan dua orang gurunya.
    \item Foto bersama siswa yang diwawancarai dan orang tuanya.
    \item Sosialisasi aplikasi SIBIKU ke pengguna melalui Zoom, dilanjutkan
    dengan pengguna mencoba aplikasi di smartphone masing-masing dan mengisi
    kuesioner.
\end{itemize}
