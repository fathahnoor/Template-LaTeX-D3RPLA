...
% --- Spasi & paragraf mengikuti DOCX: spasi 1.15, rata kiri-kanan, tanpa
%     indent awal, jarak 10pt antar paragraf (Word default). Bila prodi
%     mewajibkan spasi 1.5, ganti \setstretch{1.15} dengan
...
\begin{titlepage}
    ...
    \vspace{1cm}
    \includegraphics[width=4.67cm,height=5.66cm]{cover-banner}\par
    \vspace{1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.60cm,height=8.19cm]{komponen-android}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm,height=4.71cm]{arsitektur-aplikasi}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10.88cm,height=12.79cm]{use-case-diagram}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=9.80cm,height=4.92cm]{struktur-firebase}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=4.24cm]{struktur-sqlite}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.17cm,height=8.50cm]{skematik-iot}
...
\begin{table}[H]
    ...
    \centering
    \begin{tabular}{|c|m{5.2cm}|m{7cm}|}
        \hline
        \textbf{No.} & \centering\textbf{Komponen} & \centering\arraybackslash\textbf{Penjelasan} \\ \hline
        1 & \centering\includegraphics[width=4.00cm,height=2.72cm]{arduino-uno} & Arduino Uno\par\vspace{0.4cm}Untuk membuat berbagai hal yang berkaitan dengan fungsi mikrokontroler. \\ \hline
        2 & \centering\includegraphics[width=4.00cm,height=5.22cm]{mpu6050} & Gyroscope MPU6050\par\vspace{0.4cm}Sensor ini bisa mendeteksi gerakan kemiringan sesuai gravitasi, sehingga bisa digunakan untuk mendeteksi gerakan pengguna.\par\vspace{0.4cm}\textcolor{gray}{Catatan: gambar yang dipakai di tabel baiknya konsisten dengan di rangkaian skematik, agar pembaca lebih mudah memahaminya.} \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5.07cm,height=10cm]{struktur-kode-1}\hspace{0.3cm}\includegraphics[width=6.20cm,height=10cm]{struktur-kode-2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3.48cm,height=4.10cm]{perbedaan-ui-1}\hspace{0.3cm}\includegraphics[width=3.52cm,height=4.10cm]{perbedaan-ui-2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=11.97cm,height=7.50cm]{inspect-code}
...
\end{minipage} \\ \hline
        ...
        \textbf{Hasil} & \includegraphics[width=10cm]{test-hasil} \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.70cm,height=7.65cm]{grafik-effectiveness}
...
\section*{Lampiran 1 Dokumentasi Kegiatan}
\addcontentsline{toc}{section}{Lampiran 1 Dokumentasi Kegiatan}
\label{sec:lampiran-dokumentasi}

\begin{figure}[H]
    \centering
    \includegraphics[width=12.49cm,height=8.23cm]{lampiran-a-1}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.49cm,height=7.62cm]{lampiran-a-2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.50cm,height=7.03cm]{lampiran-a-3}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.50cm,height=7.03cm]{lampiran-a-4}
...
\clearpage
\begin{landscape}
\section*{Lampiran 2 Perhitungan Usability Test}
\addcontentsline{toc}{section}{Lampiran 2 Perhitungan Usability Test}
