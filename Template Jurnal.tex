...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{arsitektur}
    \fbox{\parbox{0.7\linewidth}{\centering\vspace{3cm}(Arsitektur Aplikasi)\vspace{3cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.7\linewidth}{\centering\vspace{3cm}(Aplikasi Hasil Implementasi)\vspace{3cm}}}
