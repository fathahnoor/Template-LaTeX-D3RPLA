...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{arsitektur}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{struktur-sqlite}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=6cm]{implementasi-1}\hspace{0.5cm}\includegraphics[height=6cm]{implementasi-2}
