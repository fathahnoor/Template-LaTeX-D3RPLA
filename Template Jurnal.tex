...
% Template Word memakai body 10 pt dengan leading rapat sekitar 10 pt.
\renewcommand{\normalsize}{\fontsize{10pt}{10pt}\selectfont}
\renewcommand{\small}{\fontsize{9pt}{9.5pt}\selectfont}
...
\AddToShipoutPictureFG*{%
  \AtPageLowerLeft{\hspace*{1.58cm}\raisebox{1.55cm}{%
    \fontsize{6pt}{7pt}\selectfont XXX-X-XXXX-XXXX-X/XX/\$XX.00~\copyright~20XX IEEE}}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=4cm,height=8.22cm]{implementasi-1}\hspace{0.3cm}\includegraphics[width=4cm,height=8.23cm]{implementasi-2}
